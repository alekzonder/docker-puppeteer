...
[![nodesource/node](http://dockeri.co/image/meetsmore/puppeteer)](https://hub.docker.com/r/meetsmore/puppeteer/)
...
```
docker pull meetsmore/puppeteer:latest
# OR
docker pull meetsmore/puppeteer:1.0.0
# OR
docker pull meetsmore/puppeteer:1
...
```bash
docker run --shm-size 1G --rm -v <path_to_script>:/app/index.js meetsmore/puppeteer:latest
```
...
```bash
docker run --shm-size 1G --sysctl net.ipv6.conf.all.disable_ipv6=1 --rm -v <path_to_script>:/app/index.js meetsmore/puppeteer:latest
```
